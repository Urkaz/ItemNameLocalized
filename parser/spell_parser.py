...
class Parser():
	def __init__(self, args):
		...
		self.lastItemID = 0
		self.strLen = 48
		self.baseUrl = 'https://eu.api.blizzard.com/wow/spell/%d'
		self.file = None
		self.removedLua = []
	...
	def Config(self, args):
		...
		if self.currLocale == "ko_KR":
			self.strLen = 28
			self.baseUrl = 'https://kr.api.blizzard.com/wow/spell/%d'
		if self.currLocale == "zh_TW":
			self.baseUrl = 'https://tw.api.blizzard.com/wow/spell/%d'
