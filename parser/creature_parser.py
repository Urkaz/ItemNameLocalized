...
class Parser():
	def __init__(self, args):
		...
		# INIT
		print("--------------------------")
		print(" \033[33mCreatureNameLocalized WoW Api Parser\033[0m")
		print("--------------------------")
		...
		self.lastItemID = 0
		self.strLen = 48
		self.baseUrl = 'https://eu.api.blizzard.com/data/wow/creature/%d'
		self.file = None
		self.removedLua = []
	...
	def Config(self, args):
		...
		if self.currLocale == "ko_KR":
			self.strLen = 28
			self.baseUrl = 'https://kr.api.blizzard.com/data/wow/creature/%d'
		if self.currLocale == "zh_TW":
			self.baseUrl = 'https://tw.api.blizzard.com/data/wow/creature/%d'
		if self.currLocale == "ru_RU":
			self.strLen = 28

		path = 'CreatureLocales/' + self.currLocale + '.lua'
	...
	def Run(self):
		...
		try:
			...
			print(" \033[32mStarting\033[0m creature parser")
			print("--------------------------")
			...
			print("--------------------------")
			print(" Stats:")
			print("\tCreatures parsed: \033[36m%i\033[0m" % (self.lastItemID - self.rangeStart))
			print("\tNew Creatures added: \033[36m%i\033[0m" % (addedItems))
			print("\tReplaced Creatures: \033[36m%i\033[0m" % (replacedItems))
			print("--------------------------")
